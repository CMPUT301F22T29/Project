...
public class ShoppingListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showShoppingListbest();

    }

    private void showShoppingListbest(){
        ...
        wholerelationship.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                for (DocumentSnapshot snapshot : task.getResult()) {
                    ...
                    if ((String.valueOf(snapshot.getString("type")).equals("ingredient")) &
                            (snapshot.getString("mealID") != null) &
                        ...
                        for (d = 0; d < requiredAllIngredientls.size(); d++) {

                            if ((requiredAllIngredientls.get(d).get(0).equals(aRequiredIngredient.get(0))) &
                                    (requiredAllIngredientls.get(d).get(1).equals(aRequiredIngredient.get(1)))) {
                                ...
                                Float theamount = Float.valueOf(0);
                                theamount += Float.parseFloat(requiredAllIngredientls.get(d).get(3));
                                theamount += Float.parseFloat(aRequiredIngredient.get(3));

                                List<String> addRequiredIngredient = new ArrayList<String>();

                                addRequiredIngredient.add(requiredAllIngredientls.get(d).get(0));
                                addRequiredIngredient.add(requiredAllIngredientls.get(d).get(1));
                                addRequiredIngredient.add(requiredAllIngredientls.get(d).get(2));
                                addRequiredIngredient.add(String.valueOf(theamount));


                                requiredAllIngredientls.set(d, addRequiredIngredient);
                    ...
                    if ((String.valueOf(snapshot.getString("type")).equals("ingredientrecipe")) &
                        ...
                        for (d = 0; d < requiredAllIngredientls.size(); d++) {
                            ...
                            if ((requiredAllIngredientls.get(d).get(0).equals(aRequiredIngredientRecipe.get(0))) &
                                    (requiredAllIngredientls.get(d).get(1).equals(aRequiredIngredientRecipe.get(1)))) {
                                ...
                                Float theamount = Float.valueOf(0);
                                theamount += Float.parseFloat(requiredAllIngredientls.get(d).get(3));
                                theamount += Float.parseFloat(aRequiredIngredientRecipe.get(3));

                                List<String> addRequiredIngredientRecipe = new ArrayList<String>();

                                addRequiredIngredientRecipe.add(requiredAllIngredientls.get(d).get(0));
                                addRequiredIngredientRecipe.add(requiredAllIngredientls.get(d).get(1));
                                addRequiredIngredientRecipe.add(requiredAllIngredientls.get(d).get(2));
                                addRequiredIngredientRecipe.add(String.valueOf(theamount));


                                requiredAllIngredientls.set(d, addRequiredIngredientRecipe);
    ...
    private void showShoppingList(){
        ...
        wholerelationship.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                ShoppingListIngredientModel shoppingListIngredientModel3 = new ShoppingListIngredientModel( presentIngredientls.get(0).get(0),
                        presentIngredientls.get(0).get(1), presentIngredientls.get(0).get(2), presentIngredientls.get(0).get(3), presentIngredientls.get(0).get(0) );

                ShoppingListIngredientModelList.add(shoppingListIngredientModel3);
